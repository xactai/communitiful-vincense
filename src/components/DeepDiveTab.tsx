...
export const DeepDiveTab: React.FC<DeepDiveTabProps> = ({ data, isDarkMode }) => {
    ...
    return (
        <div>
            <div className="flex space-x-4 border-b border-gray-200 dark:border-gray-700 mb-6 overflow-x-auto overflow-y-hidden scrollbar-hide">
            ...
            <h2 className="text-xl font-bold mb-4 text-blue-900 dark:text-blue-400">VinCense Accuracy Overview: {title}</h2>
